    ...
    CommandLineRunner initData(
        ...
        return new CommandLineRunner() {
            ...
            public void run(String... args) throws Exception {
                ...
                Member memberUser6ByKakao = memberService.whenSocialLogin("KAKAO", "").getData();
                Member memberUser7ByGoogle = memberService.whenSocialLogin("GOOGLE", "").getData();
                Member memberUser8ByNaver = memberService.whenSocialLogin("NAVER", "").getData();
                Member memberUser9ByFacebook = memberService.whenSocialLogin("FACEBOOK", "").getData();
